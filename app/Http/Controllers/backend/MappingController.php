...
class MappingController extends Controller
{
    ...
    public function index()
    {
        ...
        $m_txns = MappingTxnType::all();
        $m_pay_mode = MappingPayMode::all();
        $mapping = Mapping::orderBy('id', 'desc')->paginate(15);
        $accoutHeads = AccountHead::orderBy('fld_ac_head', 'asc')->get();
        return view('backend.mapping.index', compact('mapping', 'accoutHeads', 'm_pay_mode', 'm_txns'));
    }
    ...
    public function edit($id)
    {
        ...
        $mapping = Mapping::orderBy('id', 'desc')->paginate(15);
        $accoutHeads = AccountHead::orderBy('fld_ac_head', 'asc')->get();
        return view('backend.mapping.edit', compact('mapping', 'accoutHeads', 'mapping_info', 'm_txns', 'm_pay_mode'));
    }
