<div class="col-md-12">
    ...
    <div class="row">
        <div class="col-12 text-center">
            <a href="{{ route('deliveryNotePrint', $dnote) }}" class="btn btn-sm btn-secondary" onclick="return confirm('Want to generate Tax invoice of thi sale order? please, confirm.')"
