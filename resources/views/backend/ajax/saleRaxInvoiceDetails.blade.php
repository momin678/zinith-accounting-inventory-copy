<div class="col-md-12">
        ...
        <table class="table table-sm table-bordered">
            ...
            <tbody class="all-data-area">
               ...
               <tr class="data-row">
                   ...
                   <td>{{ $item->vat_rate }}</td>
                   <td></td>
                   <td>{{ $item->unit_price*$dn->quantity }}</td>
    ...
    <div class="row">
        <div class="col-12 text-center">
            <a href="{{ route('genTaxInvoiceDN', $dnote) }}" class="btn btn-sm btn-secondary" onclick="return confirm('Want to generate Tax invoice of thi sale order? please, confirm.')"
                target="_blank">Generate Tax Invoice</a>
