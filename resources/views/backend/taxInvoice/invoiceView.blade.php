                            ...
                            <div class="row d-flex justify-content-end pt-1">
                                <div class="col-md-4">
                                    <div class="form-group row">
                                        <label for="" class="col-5 d-flex align-items-center">TAXABLE SUPPLIES (AED):</label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group row">
                                        ...
                                        min="0" step="any" class="form-control col-7" value="{{number_format((float)( $invoice->grossTotal($invoice->invoice_no)),'2','.','') }}"
