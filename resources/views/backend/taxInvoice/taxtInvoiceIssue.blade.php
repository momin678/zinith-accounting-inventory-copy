                ...
                <section id="widgets-Statistics">
                    <div class="row">
                        <div class="col-md-10">
                            ...
                            <form action="{{ route('finalSaveInvoice') }}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8 search-item">
                            ...
                            <div class="row d-flex justify-content-end pt-1">
                                <div class="col-md-5">
                                    <div class="form-group row">
                                        <label for="" class="col-6 d-flex align-items-center">TAXABLE SUPPLIES (AED):</label>
                                        <input type="text" class="form-control col-6" name="tax_sup" id="tarek"
