                                ...
                                <div class="card-body content-padding">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3 col-12">
                                            ...
                                            <input type="text" readonly class="form-control" value="{{$purchase_temp_info->prInfo->purchase_no}}">
                                            <span class="text-danger" id="projectIdErrorMsg"></span>
                                        </div>
                                        <div class="col-sm-3 col-12">
                                            <label for="project_id">Branch Name</label>
                                            <select id="project_id" class="form-control" required disabled>
                                                <option value=""></option>
                                                @foreach ($projects as $project)
                                                    <option value="{{$project->id}}" {{$purchase_temp_info->project_id == $project->id ? "selected": ""}}>{{$project->proj_name}}</option>
                                                @endforeach
                                            </select>
                                            <input type="hidden" name="project_id" value="{{$purchase_temp_info->project_id}}">
                                            <span class="text-danger" id="projectIdErrorMsg"></span>
                                        </div>
                                        <div class="col-sm-3 col-12">
