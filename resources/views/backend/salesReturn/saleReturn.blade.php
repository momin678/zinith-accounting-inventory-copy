                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3 form-group">
                                                        <label for="">Return Sales Invoice No</label>
                                                    ...
                                                    <div class="col-md-3 form-group">
                                                        <label for=""></label>
                                                        <input type="text" class="form-control" value="Cash Customer" placeholder="Cash Customer" name="cash_customer" id="cash_customer" required readonly>
                                                    </div>
                ...
                if ($(this).val() != '') {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            $("#cost_price").val(response.unit_price);
            ...
            $('#temp_sale_return').click(function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if(response.error)
                        {
                            toastr.error("{{ Session::get('message') }}", "Invalid Quantity");
                        }
                        else
                        {
